    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Edit Demografi Desa</h4>
            </div>
            <div class="card-body">
                <form id="editForm" enctype="multipart/form-data">
                    ...
                    <button type="button" id="updateButton">Update VisiMisi</button>
                </form>
            </div>
        </div>
    </section>
...
document.getElementById('updateButton').addEventListener('click', function() {
    ...
    const id = "{{ $demografi_desa->id }}"; // ID VisiMisi yang sedang diedit
