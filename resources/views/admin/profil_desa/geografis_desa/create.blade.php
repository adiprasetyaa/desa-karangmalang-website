    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                {{-- <p class="text-subtitle text-muted">Halaman untuk membuat Info Geografis</p> --}}
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="postForm" enctype="multipart/form-data">
                    ...
                    <button type="button" id="submitButton">Tambah Info Geografis</button>
                </form>
...
document.getElementById('submitButton').addEventListener('click', function() {
    ...
    axios.post('/admin/geografis_desa', formData, {
        headers: {
