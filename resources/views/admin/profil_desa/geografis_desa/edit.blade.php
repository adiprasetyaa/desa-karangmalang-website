...
<section class="section">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Detail Geografis Desa</h4>
        </div>
        <div class="card-body">
...
const desc = {!! json_encode($geografis_desa->description) !!}; 
...
document.getElementById('updateButton').addEventListener('click', function() {
    ...
    const id = "{{ $geografis_desa->id }}"; // ID Geografis Desa yang sedang diedit
    ...
    axios.post(`/admin/geografis_desa/${id}`, formData, {
        ...
        Swal.fire({
            icon: 'success',
            title: 'Berhasil',
            text: 'Geografis Desa berhasil diperbarui.',
        });
    }).catch(error => {
        Swal.fire({
            icon: 'error',
            title: 'Gagal',
            text: 'Gagal memperbarui Geografis Desa.',
        });
    });
});
</script>
