    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div>
                        <a href="/"><img src="{{ asset('assets/guest') }}/static/images/logo/logo_colorful.png" alt="Logo" style="width: 240px;"></a>
                    </div>
                    ...
                    <form action="{{ route('admin.login') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary btn-block btn-lg shadow-lg mt-5" style="background-color: #0096DC; border-color: #0096DC;">Masuk</button>
                    </form>
