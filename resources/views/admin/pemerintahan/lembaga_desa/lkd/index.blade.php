                        ...
                        <tbody>
                            @foreach ($lkd as $lkd_data)
                                <tr data-bs-idlkd="{{ $lkd_data->id }}">
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-idlkd="{{ $lkd_data->id }}" data-bs-target="#editForm">
                                            Edit
                                        </button>
                                        <button type="button" class="btn btn-danger block" data-bs-toggle="modal"
                                            data-bs-target="#deleteModal" data-bs-idlkd="{{ $lkd_data->id }}">
                                            Hapus
                                        </button>
                                    </td>
                                </tr>
