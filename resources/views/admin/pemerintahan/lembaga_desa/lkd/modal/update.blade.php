        ...
        <div class="modal-content">
            ...
            <form action="#">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="lkd_update" class="btn btn-primary ms-1"
                        data-bs-dismiss="modal">
...
<script>
    ...
    editModal.addEventListener('show.bs.modal', function (event) {
        ...
        .then(data => {
            ...
            $('#myModalLabel33').text(`Data LKD`);
            $('#nama').val(lkd.Nama);
            $('#jabatan').val(lkd.Jabatan);

            // add data-bs to update button
            $('#lkd_update').attr('data-bs-idlkd', lkd.id);
    ...
    let updateButton =  document.getElementById('lkd_update');
    updateButton.addEventListener('click', function(event){
        let idLkd = updateButton.getAttribute('data-bs-idlkd');
        changed_Lkd_id = idLkd;
        let url = "{{ route('admin.lkd.update', ':id') }}";
        url = url.replace(':id', idLkd); 
        ...
        .then(data => {
            // Replace Data
            console.log(data);
            let lkdRow = $(`tr[data-bs-idlkd="${idLkd}"]`);
            console.log(lkdRow);
            if (lkdRow.length) {
