                        ...
                        <tbody>
                            @foreach ($lpmd as $lmpd_data)
                                <tr data-bs-idlpmd="{{ $lmpd_data->id }}">
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-idlpmd="{{ $lmpd_data->id }}" data-bs-target="#editForm">
                                            Edit
                                        </button>
                                        <button type="button" class="btn btn-danger block" data-bs-toggle="modal"
                                            data-bs-target="#deleteModal" data-bs-idlpmd="{{ $lmpd_data->id }}">
                                            Hapus
                                        </button>
                                    </td>
                                </tr>
