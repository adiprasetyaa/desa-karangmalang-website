            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table" id="table1">
                        ...
                        <tbody>
                            @foreach ($bumdes as $index => $bumdes_data)
                                <tr data-bs-idbumdes="{{ $bumdes_data->id }}">
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $bumdes_data->Nama }}</td>
                                    <td>{{ $bumdes_data->Jabatan }}</td>
                                    <td>
                                        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-idbumdes="{{ $bumdes_data->id }}" data-bs-target="#editForm">
                                            Edit
                                        </button>
                                        <button type="button" class="btn btn-outline-primary block" data-bs-toggle="modal"
                                            data-bs-target="#deleteModal" data-bs-idbumdes="{{ $bumdes_data->id }}">
                                            Hapus
                                        </button>
                                    </td>
                                </tr>
