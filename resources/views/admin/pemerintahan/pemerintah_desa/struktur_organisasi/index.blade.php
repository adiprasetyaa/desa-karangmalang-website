        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if ($struktur_organisasi->image)
                    ...
                    <img src="{{ Storage::url($struktur_organisasi->image) }}" alt="Struktur Organisasi" class="img-fluid" style="max-width: 100%; height: auto;">
                @else
            ...
            <div class="ms-4 mb-4">
                <a href="{{ route('admin.struktur_organisasi.edit', $struktur_organisasi->id) }}" class="btn btn-primary" style="width: 200px;">Edit Data</a>
            </div>
        </div>
    </section>
@endsection
