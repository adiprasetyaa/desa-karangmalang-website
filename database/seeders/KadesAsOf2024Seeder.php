...
class KadesAsOf2024Seeder extends Seeder
{
    ...
    {
        $noto_karsono = Kades::create([
            'name' => 'Noto Karsono',
            'period_start_at' => '1946-01-01',
            'period_end_at' => '1988-12-31',
        ]);

        $jumadi_ap = Kades::create([
            'name' => 'Jumadi AP',
            'period_start_at' => '1988-01-01',
            'period_end_at' => '1993-12-31',
        ]);

        $sunarto_noto_yuwono = Kades::create([
            'name' => 'Sunarto Noto Yuwono',
            'period_start_at' => '1993-01-01',
            'period_end_at' => '2007-12-31',
        ]);

        $sarjono = Kades::create([
            'name' => 'Sarjono',
            'period_start_at' => '2007-01-01',
            'period_end_at' => '2013-12-31',
        ]);

        $suyamto = Kades::create([
            'name' => 'Suyamto',
            'period_start_at' => '2013-01-01',
            'period_end_at' => '2019-12-31',
        ]);

        $sarjono = Kades::create([
            'name' => 'Sarjono',
            'period_start_at' => '2019-01-01',
